...
namespace Obloq {
    ...
    */
    ...
    //% advanced=true        
    export function Obloq_ThingSpeak_post(myKey: string, field1?: number, field2?: number, field3?: number, field4?: number, field5?: number, field6?: number, time?: number): string {
        while (OBLOQ_WORKING_MODE_IS_STOP) { basic.pause(20) }
        if (!OBLOQ_HTTP_INIT)
            return OBLOQ_STR_TYPE_IS_NONE
